...
<head>
    <meta charset="utf-8">
    <title>DIT - Blog | Events | News</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="" class="nav-item nav-link active">Events & News</a>
                            ...
                            <div class="row">
                                @foreach($images as $image)
                                    <div class="col-md-4 mb-4">
                                        <a href="{{ asset('storage/' . $image) }}" data-lightbox="event-gallery" data-title="{{ $event->title }}">
                                            <img class="img-fluid w-100 rounded" src="{{ asset('storage/' . $image) }}" alt="{{ $event->title }}">
                                        </a>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        @foreach($recentEvents as $recentEvent)
                            <div class="d-flex rounded overflow-hidden mb-3">
                                <img class="img-fluid" src="{{ asset('storage/' . $image) }}" style="width: 100px; height: 100px; object-fit: cover;" alt="{{ $recentEvent->title }}">
                                <a href="{{ route('events.show', $recentEvent->id) }}" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">{{ $recentEvent->title }}</a>
                            </div>
                        @endforeach
                    </div>
                    <!-- Recent Post End -->
